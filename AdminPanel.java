...
/**
 * Creates an interactable admin page for executing commands, managing user content.
 * @author jaimoraes
 */
public class AdminPanel extends javax.swing.JFrame {

    //create a Customer object to store the current administrator user
    private Customer user;

    /**
     * Creates new form AdminPanel,
     *instantiates a new admin panel and creates a deep copy of the Customer admin passed through
     */
    public AdminPanel(Customer c) {
        //call pre-generated methods
        initComponents();
        
        //set up background and set visible
        ...
        //create a deep copy of the Admin user
        this.user = new Customer(c);
    }//Constructor

    /**
    8NOT COMMENTED AS IT IS AUTO-GENERATED
    ...
    /**
    *Prints a help message for commands to the screen
    */
    private void help() {
        this.addText(
    ...
    /**
    *deletes the specified book or chat
    *@param input the parsed command input from the command line
    */
    private void delete(String[] input){
        ...
        if(input.length<3)
        ...
        else{ //If there are the correct number of parameters
            
            //check that 'book' or 'chat' is selected
            if(input[1].equalsIgnoreCase("book")||input[1].equalsIgnoreCase("chat")){
                //processing deleting the chat/books
                
                //process dleeting a chat
            ...
            }else //checking if book or chat is selected
    ...
    /**
    *Prints a given chat file to the screen
    *@param input the seperated administrator input
    */
    private void viewChat(String[] input){
        ...
        if(input.length!=2)
            ...
            if(newFile.exists()){
                ...
                this.Error.setText("Error: Chat does not exist");
        }//length if tree
    }//viewChat method
